<template>
  <div @click="this.$store.commit('TOGGLE_EDITOR_RIGHT_FOLDED')">
    <div class="absolute left-0 bottom-0 ml-4 mb-2 rounded hover:bg-gray-200 cursor-pointer">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
